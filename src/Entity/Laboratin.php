...
class Laboratin
{
    ...
    #[ORM\OneToOne(mappedBy: 'laboratin', cascade: ['persist', 'remove'])]
    ...
    public function setUtilisateur(?User $utilisateur): static
    {
        ...
        if ($utilisateur === null && $this->utilisateur !== null) {
            $this->utilisateur->setLaboratin(null);
        }

        // set the owning side of the relation if necessary
        if ($utilisateur !== null && $utilisateur->getLaboratin() !== $this) {
            $utilisateur->setLaboratin($this);
        }
