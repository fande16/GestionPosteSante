...
class Receptioniste
{
    ...
    #[ORM\OneToOne(mappedBy: 'receptioniste', cascade: ['persist', 'remove'])]
    ...
    public function setUtilisateur(?User $utilisateur): static
    {
        ...
        if ($utilisateur === null && $this->utilisateur !== null) {
            $this->utilisateur->setReceptioniste(null);
        }

        // set the owning side of the relation if necessary
        if ($utilisateur !== null && $utilisateur->getReceptioniste() !== $this) {
            $utilisateur->setReceptioniste($this);
        }
